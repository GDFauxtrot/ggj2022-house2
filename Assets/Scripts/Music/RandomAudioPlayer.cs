...
public class RandomAudioPlayer : MonoBehaviour
{
    ...
    protected int audioSourcesIndex = 0;
    protected Dictionary<Material, SoundBank[]> m_Lookup = new Dictionary<Material, SoundBank[]>();

    public AudioSource audioSource { get { return m_Audiosources[audioSourcesIndex]; } }
    ...
    public float volume = 1;
     ...
     public AudioSource NextAudioSource() { 
      audioSourcesIndex=(audioSourcesIndex+1)%m_Audiosources.Length;
      return m_Audiosources[audioSourcesIndex];
      }
    ...
    public void PlayRandomClip()
    {
      ...
      public void PlayRandomClipDisambiguation()
    {
        PlayRandomClip();
    }
